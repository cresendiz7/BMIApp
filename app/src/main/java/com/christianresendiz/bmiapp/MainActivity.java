...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                try {
                    if (heightFt.getText().toString().trim().equals("") && heightFt.getText().toString().trim().equals("") && weight.getText().toString().trim().equals("")) {
                        Toast.makeText(MainActivity.this, "You did not enter a height or a weight", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (heightFt.getText().toString().trim().equals("") && heightIn.getText().toString().trim().equals("")) {
                        Toast.makeText(MainActivity.this, "You did not enter a height", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (heightFt.getText().toString().trim().equals("") && radioButtonMet.isChecked()) {
                        Toast.makeText(MainActivity.this, "You did not enter a height", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (weight.getText().toString().trim().equals("")) {
                        Toast.makeText(MainActivity.this, "You did not enter a weight", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                    ...
                    Toast.makeText(MainActivity.this, "Please enter a valid height/weight", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        heightFt.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
